  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      it "redirects to the created admin_product" do
        post admin_products_url, params: { admin_product: valid_attributes }
        expect(response).to redirect_to(admin_product_url(@admin_product))
      end
    end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested admin_product" do
        product = Admin::Product.create! valid_attributes
        patch admin_product_url(admin_product), params: { admin_product: new_attributes }
        product.reload
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        product = Admin::Product.create! valid_attributes
        patch admin_product_url(admin_product), params: { admin_product: invalid_attributes }
        expect(response).to be_successful
      end
    end
  end
